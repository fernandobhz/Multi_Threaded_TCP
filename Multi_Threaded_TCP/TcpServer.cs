...
namespace Multi_Threaded_TCP
{
    ...
    public class CrcGT06
    {
        //http://stackoverflow.com/questions/10167461/crc-itu-calculation-in-c-sharp
        ...
        private static ushort flipEndian(ushort value)
        {
        ...
        private static ushort GetCrc16(byte[] data, int offset, int length)
        {
            ushort fcs = 0xFFFF;
        ...
        // //http://ppcode.blogbus.com/logs/1656947.html
        // {        
        //     static ushort[] crctab16 =
        //{
        // 0x0000, 0x1189, 0x2312, 0x329b, 0x4624, 0x57ad, 0x6536, 0x74bf,
